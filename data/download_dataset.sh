...
wget --no-check-certificate ${url} -O ${dataset_root}/multispectral_kaist_datasets.tar

echo ""
echo "Extract dataset (takes > 10 mins)"
echo ""
tar zxvf ${dataset_root}/multispectral_kaist_datasets.tar >/dev/null 2>&1 && rm ${dataset_root}/multispectral_kaist_datasets.tar
