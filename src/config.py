...
# set those values when debugging.
if debug:
    train.wandb_enable = False
    train.batch_size = 1
    train.start_epoch = 0
    dataset.workers = 0
